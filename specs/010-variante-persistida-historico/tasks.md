...
- [X] T022 Rodar `pnpm --filter @helux/web test` e `pnpm typecheck` (monorepo), confirmando que T015–T017 passam e nenhum teste existente quebrou (em especial `ExerciseSheet.test.tsx` e `useActiveWorkout.test.ts`)
- [X] T023 Executar `quickstart.md` passos 6–9 contra o app rodando localmente e rodar de novo o passo 5 (badge de fit sem troca) como regressão
